...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        buttons = [push0,push1,push2,push3,push4,push5,push6,push7,push8,push9,push0]
        for i in buttons:
            i.setStyleSheet("background-color: #8a8786; color: white;")
        ...
        function_keys = [push_minus,push_point,push_div,push_mul,push_plus]
        for j in function_keys:
            j.setStyleSheet("background-color: #575757; color: white;")

        fK = [push_del,push_clear]
        for a in fK:
            a.setStyleSheet("background-color: 827d79; color: black;")
